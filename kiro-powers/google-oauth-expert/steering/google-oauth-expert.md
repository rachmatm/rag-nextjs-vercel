...
live, curated knowledge base available through the `dev-knowledge` MCP server.
Use it as your primary reference before answering Google OAuth questions or
attempting a fix.
...
- NEVER pass any of these Forbidden_Stacks to any tool: `"nextjs-vercel"`,
  `"react-native"`, `"google-calendar"`, `"google-sheets"`. Those are other
  experts' domains.
